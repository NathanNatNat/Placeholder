...
std::pair<uint32_t, uint32_t> jenkins96(std::span<const uint8_t> k, uint32_t init, uint32_t init2)
{
    ...
    while (len > 12)
    {
        a += static_cast<uint32_t>(k[o])     | static_cast<uint32_t>(k[o+1])  << 8
           | static_cast<uint32_t>(k[o+2])  << 16 | static_cast<uint32_t>(k[o+3])  << 24;
        b += static_cast<uint32_t>(k[o+4])  | static_cast<uint32_t>(k[o+5])  << 8
           | static_cast<uint32_t>(k[o+6])  << 16 | static_cast<uint32_t>(k[o+7])  << 24;
        c += static_cast<uint32_t>(k[o+8])  | static_cast<uint32_t>(k[o+9])  << 8
           | static_cast<uint32_t>(k[o+10]) << 16 | static_cast<uint32_t>(k[o+11]) << 24;
